...
개발자라면 한 번쯤 생각만 하다 마는 사이드 프로젝트들을 생각나는 대로 던져두는 낙서장이다.
...
근데 논문 발표 전까지는 private으로 둘련다 — ~~믿을 사람 없음.~~
...
일부 프로젝트는 학교에서 시작된 프로젝트, AI 실험, FPGA/NPU 연구, WebGPU 시각화, LLM 병목 분석을 정리하는 비공식 학생 프로젝트 아카이브입니다.
컴공 · AI융합 · 임베디드 · 지능형반도체 학생들이 *"내 GitHub 어떻게 정리하지?"* 싶을 때 참고용으로 봐도 됨.
...
~~Apache 2.0 / MIT 라이센스 걸어둠.~~  
가져가서 쓰는 건 자유. 대신 star나 fork 한 번은 눌러주세요ㅠ

</details>

> 개인이 굴리는 비공식 학생 프로젝트 아카이브.  
...
Some of this started as undergraduate work at My University. Possibly useful if you're working on capstones, AI reports, GitHub workflows, FPGA/NPU/LLM experiments, or trying to make coursework look more like a portfolio than homework.
